...
namespace Cube_3D
{
    class Program
    {
        static void Main()
        {
            ...
            //{//side
            //    for (int j = 0; j < n - 2; j++)//Този цикъл ни рисува всички | под най-горния диагонал
            //    {
            //        Console.SetCursorPosition(n + j, i + j);//n и i са ни началните координати на първия вертикал
