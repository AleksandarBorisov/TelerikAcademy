...
namespace _1.NumeralSystems
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            Console.WriteLine(BitConverter.IsLittleEndian);//Показва в какъв решим работи класа и как се съхраняват данните за текущата компютърна архитектура
...
//Делим още веднъж и получаваме цифрата на стотиците(0,3) в дробната част. Същата логика прилагаме с дробни число(0,386)
